...
aria2c --enable-rpc=true rpc-secure=true --check-certificate=false --daemon=true \
   ...
   --bt-enable-lpd=true --bt-min-crypto-level=arc4 --bt-require-crypto=true --seed-time=0 --max-file-not-found=0 --max-tries=20 \
